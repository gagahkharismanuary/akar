...
<!-- End of Topbar -->
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Canceled</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php echo $canceled ?>
                      </div>
                    </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                  <h4 class="small font-weight-bold">Total Projects 
  ...
  <!-- Page level plugins -->
  <script src="<?php echo assets_url('vendor/chart.js/Chart.min.js')?>"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo assets_url('js/demo/chart-area-demo.js')?>"></script>
  <script src="<?php echo assets_url('js/demo/chart-pie-demo.js')?>"></script>
